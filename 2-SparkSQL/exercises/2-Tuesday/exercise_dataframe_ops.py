...
from pyspark.sql.functions import col, lit, when, upper, desc
...
df.filter((col('hire_date') > '2020-01-01') & (col('salary') > 60000)).show()
...
result = df.filter(col('hire_date') > '2020-01-01') \
